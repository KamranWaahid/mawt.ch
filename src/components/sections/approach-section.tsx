...
export function ApproachSection({ dict }: { dict: any }) {
  ...
  // Same scrub on phone + desktop: vertical scroll drives the horizontal slide.
  // Touch devices keep native document scroll (Lenis is off there), so the pin
  // tracks finger momentum 1:1 without a nested horizontal carousel.
