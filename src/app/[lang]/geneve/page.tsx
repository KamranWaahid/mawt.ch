...
const COPY = {
  fr: {
    ...
    wikiSub: "Cinq familles, un point d'entrée. Chaque famille regroupe nos services détaillés pour les entreprises de Genève et de Suisse romande.",
    explore: "Explorer",
    familyBlurb: {
      "sites-et-branding": "Sites internet, e-commerce, branding et refontes orientés croissance.",
      "solutions-ia": "CRM intelligent, agents IA, RAG, automatisation et applications sur mesure.",
  ...
  en: {
    ...
    wikiSub: "Five families, one entry point. Each family groups our detailed services for businesses in Geneva and French speaking Switzerland.",
    explore: "Explore",
    familyBlurb: {
      "sites-et-branding": "Websites, e-commerce, branding and redesigns built for growth.",
      "solutions-ia": "Smart CRM, AI agents, RAG, automation and custom applications.",
