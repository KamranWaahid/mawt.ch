...
const problems = [
  {
    ...
    description:
      "Swiss companies wait weeks or months to hire developers, designers, and technical talent while deadlines keep getting closer. Opportunities are lost before teams are even in place.",
  },
  {
    title: "Your systems are disconnected",
    description:
      "CRMs, project tools, internal workflows, and reporting platforms often operate in silos, creating manual handoffs, errors, and wasted time across your business.",
  },
  {
    title: "Agencies give advice, not execution",
    description:
      "Most partners deliver strategy decks, recommendations, or partial solutions then leave your team to figure out implementation on their own.",
  },
  {
    title: "Growth creates operational chaos",
    description:
      "As your company scales, manual processes break, teams become overloaded, and execution slows down because your infrastructure wasn't built to handle growth.",
  },
] as const;
...
export function ProblemSection({ dict }: { dict: any }) {
  return (
    ...
    >
      ...
      >
        <div className="absolute right-0 top-0 h-[500px] w-[500px] -translate-y-1/2 translate-x-1/4 rounded-full bg-emerald-500/10 blur-[100px]" />
        <div className="absolute bottom-0 left-0 h-[400px] w-[400px] -translate-x-1/4 translate-y-1/4 rounded-full bg-emerald-600/5 blur-[80px]" />
      </div>
